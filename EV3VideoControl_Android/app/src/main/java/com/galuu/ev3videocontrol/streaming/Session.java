...
package com.galuu.ev3videocontrol.streaming;
...
import com.galuu.ev3videocontrol.streaming.audio.AudioStream;
...
import com.galuu.ev3videocontrol.streaming.exceptions.StorageUnavailableException;
import com.galuu.ev3videocontrol.streaming.gl.SurfaceView;
import com.galuu.ev3videocontrol.streaming.rtsp.RtspClient;
...
public class Session {
	...
	public Session() {
		...
		HandlerThread thread = new HandlerThread("com.galuu.ev3videocontrol.streaming.Session");
		thread.start();
