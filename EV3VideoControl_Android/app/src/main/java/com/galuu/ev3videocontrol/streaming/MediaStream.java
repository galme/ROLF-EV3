...
import com.galuu.ev3videocontrol.MainActivity;
import com.galuu.ev3videocontrol.streaming.audio.AudioStream;
import com.galuu.ev3videocontrol.streaming.rtp.AbstractPacketizer;
...
public abstract class MediaStream implements Stream {
	 ...
	 * {@link VideoStream#setVideoQuality(com.galuu.ev3videocontrol.streaming.video.VideoQuality)}
	 * for a {@link VideoStream} and {@link AudioStream#setAudioQuality(com.galuu.ev3videocontrol.streaming.audio.AudioQuality)}
	...
	public synchronized void start() throws IllegalStateException, IOException {
		...
		if (mMode != MODE_MEDIARECORDER_API) {
			...
			if  (MainActivity.forceMediaCodec)
				encodeWithMediaCodec();
			else
	...
	/**
	 * Returns the SSRC of the underlying {@link com.galuu.ev3videocontrol.streaming.rtp.RtpSocket}.
